...
function Header()
{
    ...
    $this->Cell(100);
    // Title
    $this->Cell(80,10,'Open Order List',1,0,'C');
    // Line break
    $this->Ln(20);
}
...
$result = mysqli_query($connString, "SELECT orderID, order_date, item_number, item_description, custID, item_size, item_qty, animal, other_explain, empID, placedBy, placedDate, arrivalDate, calledDate, calledBy, pickedUpDate, orderOpen FROM psrsm_spos.orders WHERE orderOpen = '1'") or die("database error:". mysqli_error($connString));
